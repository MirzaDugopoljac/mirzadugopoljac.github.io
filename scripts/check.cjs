...
const pages = ['itech.html','camurun-sirli-hali-hero-pack/index.html','index.html','about.html','contact.html','portfolio/index.html',...context.window.PROJECTS.map(p=>`portfolio/projects/${p.slug}.html`)];
const errors=[];
