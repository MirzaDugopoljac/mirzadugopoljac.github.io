...
Object.assign(additions, require('./editorial.cjs').translations);
...
console.log('Built 11 static pages with English fallback content.');
const outputPages = ['index.html','about.html','contact.html','portfolio/index.html',...projects.map(p=>`portfolio/projects/${p.slug}.html`)];
